...
<main class="w-75 mx-auto border rounded-5 p-5">
    ...
    <div class="d-flex mt-3 align-items-end">
        <div>
            ...
            <input type="text" name="zipcode" value="<?= $row['zipcode']; ?>" id="f_zipcode" class="form-control" maxlength="5" minlength="5">
        </div>
    ...
    <div class="d-flex mt-3 gap-2 justify-content-between">
        ...
        <input type="text" class="form-control" name="addr2" id="f_addr2" placeholder="상세주소를 입력해주세요" value="<?= $row['addr2']; ?>">
        </div>
    </div>
